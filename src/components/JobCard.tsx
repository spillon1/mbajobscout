...
import { ExternalLink, Building2, MapPin, Calendar, X, Copy, Check, CheckCircle2, Bookmark, Info } from 'lucide-react';
    ...
    <>
      <div className="relative overflow-hidden rounded-md">
        {isSwiping && isSwipingRight && (
          <div className="absolute inset-0 flex items-center pl-4 rounded-md bg-success/20 z-0" style={{ opacity: swipeProgress }}>
        ...
        {isSwiping && isSwipingLeft && (
          <div className="absolute inset-0 flex items-center justify-end pr-4 rounded-md bg-destructive/20 z-0" style={{ opacity: swipeProgress }}>
        ...
        <a
          ...
          onClick={(e) => {
            if (hasSwipedRef.current) { e.preventDefault(); return; }
        ...
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="shrink-0 hidden sm:flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              {onSaved && (
                <button
                  onClick={(e) => { e.preventDefault(); e.stopPropagation(); onSaved(job); }}
              ...
              {onNotInterested && (
                <button
                  onClick={(e) => { e.preventDefault(); e.stopPropagation(); onNotInterested(job); }}
              ...
              {onApplied && (
                <button
                  onClick={(e) => { e.preventDefault(); e.stopPropagation(); onApplied(job); }}
