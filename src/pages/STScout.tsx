          ...
          <div className="flex items-center justify-between gap-2 min-w-0">
            <div className="flex items-center gap-2 shrink-0">
              ...
              <nav className="flex items-center gap-1 ml-2 sm:ml-4">
                ...
                <Link to="/st" className="px-2.5 py-1 rounded-md text-xs font-display uppercase tracking-wider bg-primary/10 text-primary border border-primary/20">S&T</Link>
