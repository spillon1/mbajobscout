...
const Index = () => {
  ...
  const baseFilteredJobs = useMemo(() => {
    ...
    return filtered;
  }, [jobs, dismissedIds, isActioned, selectedCompanies, selectedTitles, filterKeywords, selectedSources, sources, datePostedFilter, listedPeriod, selectedSeniorities, selectedSubCategories, selectedSecondaryFilter, selectedPayRanges, customPayRange]);
  ...
  return (<>
    <div className="min-h-screen bg-background bg-grid">
      <NavBar activeTab="/" selectedCity={selectedCity} onCityChange={handleCityChange} isSearching={isSearching} onSearch={handleScrape} onStop={handleStopScrape} onSignInClick={() => setShowAuthModal(true)} />
      ...
      <div className="border-b border-border bg-muted sticky top-[53px] z-40">
        <div className="container max-w-6xl mx-auto px-4 py-1.5 flex items-center gap-4 font-display text-[11px] uppercase tracking-wider text-muted-foreground">
          <span className="whitespace-nowrap">Venture Capital</span>
      ...
      <main className="container max-w-6xl mx-auto px-4 py-6 space-y-4">
        ...
        <FilterRow
          ...
          onCustomPayRangeChange={setCustomPayRange}
          onClearFilters={() => {
            setListedPeriod('any');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 items-start">
          ...
          <div className="lg:col-span-3 space-y-2">
            ...
            <div className="border border-border rounded-md bg-card p-12 text-center">
                ...
                <p className="font-display text-sm text-foreground mb-1">Ready to find VC jobs</p>
