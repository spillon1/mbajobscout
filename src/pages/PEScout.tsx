...
const PEScout = () => {
  ...
  const [customPayRange, setCustomPayRange] = usePersistedState<CustomPayRange>('pe-custompay', { min: null, max: null });
  ...
  const baseFilteredJobs = useMemo(() => {
    ...
    return filtered;
  }, [jobs, dismissedIds, isActioned, selectedCompanies, selectedTitles, filterKeywords, selectedSources, sources, datePostedFilter, listedPeriod, selectedSeniorities, selectedCity, selectedSubCategories, selectedSecondaryFilter, selectedTertiaryFilter, selectedPayRanges, customPayRange]);
    ...
    <div className="min-h-screen bg-background bg-grid">
      ...
      <div className="border-b border-border bg-muted sticky top-[53px] z-40">
        <div className="container max-w-6xl mx-auto px-4 py-1.5 flex items-center gap-4 font-display text-[11px] uppercase tracking-wider text-muted-foreground">
          <span className="whitespace-nowrap">Private Equity</span>
          ...
          <div className="lg:col-span-3 space-y-2">
            {viewMode === 'saved' ? (
              ...
              <div className="border border-border rounded-md bg-card p-12 text-center">
                ...
                <p className="font-display text-sm text-foreground mb-1">Ready to find PE jobs</p>
